...
export default function Courses() {
    ...
    const handleScroll = () => {
      ...
      if (scrollPosition >= pageHeight - 200) {
        ...
        setVisibleCount((prev) => {
          ...
          if (prev >= allCourses.length) return prev;
          return prev + 6;
        });
  ...
  const displayedCourses = allCourses.slice(0, visibleCount);
  ...
  return (
    <div className="py-20 bg-black text-white">
      ...
      <div className="p-4 relative z-10 w-full text-center">
        <h2 className="mt-10 md:mt-0 text-3xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 tracking-wide">
          FEATURED COURSES
        </h2>
        <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
          Learn With the Best. Explore our massive library of premium content.
        </p>
      </div>


      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <HoverEffect items={displayedCourses} />
      </div>
